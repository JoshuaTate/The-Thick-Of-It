package com.jjcraft.ttoi.block;

import com.jjcraft.ttoi.block.custom.*;
import com.jjcraft.ttoi.block.entity.ModWoodTypes;
import com.jjcraft.ttoi.sound.ModSounds;
import com.jjcraft.ttoi.world.feature.tree.EbonyTreeGrower;
import com.jjcraft.ttoi.TTOIMain;
import com.jjcraft.ttoi.item.ModCreativeModeTab;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, TTOIMain.MOD_ID);
    ...
    public static final RegistryObject<Block> SPEEDY_BLOCK = registerBlock("speedy_block",
            () -> new SpeedyBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(4f).requiresCorrectToolForDrops()), ModCreativeModeTab.TUTORIAL_TAB, "tooltip.ttoi.block.speedy_block");
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /*  THE THICK OF IT CUSTOM MODS!
        LEAVE TEMPLATE STRUCTURE INTACT AND ONLY ADD TO IT FOR NOW
     */
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    public static final RegistryObject<Block> CORBYNITE_BLOCK = registerBlock("corbynite_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN)), ModCreativeModeTab.TUTORIAL_TAB);
