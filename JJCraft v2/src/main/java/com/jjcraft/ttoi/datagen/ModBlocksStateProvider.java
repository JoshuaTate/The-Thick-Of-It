package com.jjcraft.ttoi.datagen;

import com.jjcraft.ttoi.TTOIMain;
import com.jjcraft.ttoi.block.ModBlocks;
import com.jjcraft.ttoi.block.custom.CucumberPlantBlock;
...
public class ModBlocksStateProvider extends BlockStateProvider {
    public ModBlocksStateProvider(DataGenerator gen, ExistingFileHelper exFileHelper) {
        super(gen, TTOIMain.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlock((DoorBlock) ModBlocks.EBONY_DOOR.get(), new ResourceLocation(TTOIMain.MOD_ID, "block/ebony_door_bottom"),
                new ResourceLocation(TTOIMain.MOD_ID, "block/ebony_door_top"));
        ...
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_LOG.get(), new ResourceLocation(TTOIMain.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(TTOIMain.MOD_ID, "block/stripped_ebony_top"));
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_WOOD.get(), new ResourceLocation(TTOIMain.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(TTOIMain.MOD_ID, "block/stripped_ebony_top"));
    ...
    private ConfiguredModel[] states(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(block.getAgeProperty()),
                new ResourceLocation(TTOIMain.MOD_ID, "block/" + textureName + state.getValue(block.getAgeProperty()))));
